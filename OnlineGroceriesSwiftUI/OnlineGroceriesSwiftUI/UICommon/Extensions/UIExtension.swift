...
extension CGFloat {
    ...
    static var horizontalInsets: Double {
        ...
        let leftAndRight = Double(keyWindow?.safeAreaInsets.left ?? 0.0) + Double(keyWindow?.safeAreaInsets.right ?? 0.0)
        return leftAndRight
    }
    static var verticalInsets: Double {
        ...
        let topAndBottom = Double(keyWindow?.safeAreaInsets.top ?? 0.0) + Double(keyWindow?.safeAreaInsets.bottom ?? 0.0)
        return topAndBottom
    }
}
